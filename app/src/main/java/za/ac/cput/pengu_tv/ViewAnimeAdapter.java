...
public class ViewAnimeAdapter extends RecyclerView.Adapter<ViewAnimeAdapter.MyViewHolder> {
    ...
    DBHelper db;
    String getUser, getAnimeName, getGenre, getRating,getAnimeId, getEpisodeAmount;
    SQLiteDatabase sqLiteDatabase;

    private ArrayList animeName, animeGenre, animeRating,animeEpisode;
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    getAnimeId = cursor.getString(0);



                    getAnimeName = cursor.getString(1);
                    ...
                    getGenre = cursor.getString(6);
                    getRating = cursor.getString(7);
                    ...
                    intent.putExtra("passEpisodes",getAnimeEpisodeAmount);
                    intent.putExtra("passGenre", getGenre);
                    intent.putExtra("passRating", getRating);
